...
b = tk.Button(root, text="🔐Generate Password", font=("Times", 14), command=gen_pass)#Button
b.pack(pady=20)
l = tk.Label(root, font=("Times", 14, "italic"), fg="Blue", bg="#f0f0f0")#Displaying password
l.pack(pady=20)
root.mainloop()#Run
